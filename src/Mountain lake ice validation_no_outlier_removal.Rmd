...
ggsave(here('output/figs_for_JASM/castle_2016_no_fit_title.png'), dpi = 500)
```
...
#ggsave(here('output/figs_for_JASM/comparison_2.png'), dpi = 500, width = 15, height = 10)
...
merged_pdates %>% 
  ...
  ungroup() %>% 
  arrange(event, MAE)
#write_csv(error, here('data/combined/error_pdates_2022.04.19.csv'))
...
#ggsave(here('output/figs_for_JASM/one_one_plt.png'), dpi = 500, height = 7, width = 10)
...
# validation %>% 
#   ggsave(filename = here("output/logistic_regression_results/validation_h0.1.png"),
#          width = 7,
#          height = 5)
# 
# 
